...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method method1 = null;
        for (Class<?> clazz = pageClass; method1 == null && clazz != null; clazz = clazz.getSuperclass()) {
            try {
                method1 = clazz.getDeclaredMethod("before", HttpServletRequest.class, Map.class);
        ...
        Method method2 = null;
        for (Class<?> clazz = pageClass; method2 == null && clazz != null; clazz = clazz.getSuperclass()) {
            try {
                method2 = clazz.getDeclaredMethod("after", HttpServletRequest.class, Map.class);
            } catch (NoSuchMethodException ignored) {
                // No operations.
            }
        }
