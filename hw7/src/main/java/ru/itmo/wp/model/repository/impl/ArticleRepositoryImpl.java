...
public class ArticleRepositoryImpl implements ArticleRepository {
    ...
    public void post(Article article) {
        try (Connection connection = DATA_SOURCE.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement("INSERT INTO `Article` (`userId`, `title`," +
                    " `text`,`creationTime`) VALUES (?, ?, ?, NOW())", Statement.RETURN_GENERATED_KEYS)) {
                ...
                if (statement.executeUpdate() != 1) {
                    ...
                    if (generatedKeys.next()) {
                        ...
                        article.setCreationTime(article.getCreationTime());
                    } else {
